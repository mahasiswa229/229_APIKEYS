...
            <style>
                :root {
                    --primary: #1d3557;         /* Biru Navy (Dominan Gelap) */
                    --primary-dark: #1d3557;    /* Sama */
                    --secondary: #457b9d;       /* Biru Langit Sedang */
                    --accent: #a8dadc;          /* Biru Langit Sangat Cerah */
                    --dark: #2c3e50;
                    --light: #f8f9fa;
                    --success: #2ecc71;
                    --warning: #f39c12;
...
                    background: linear-gradient(135deg, var(--accent), var(--secondary), var(--primary)); /* Menggunakan skema biru langit */
                    display: flex; 
...
                    width: 100%;
                    height: 5px;
                    background: linear-gradient(90deg, var(--primary), var(--secondary), var(--accent)); /* Ganti Warna Strip */
...
                    border-color: var(--secondary); /* Ganti Warna Fokus */
...
                
                button { 
                    background: linear-gradient(135deg, var(--primary), var(--secondary)); /* Ganti Warna Tombol */
                    color: white; 
                    border: none; 
                    padding: 16px; 
                    border-radius: 12px; 
...
                
                .link-container a { 
                    color: var(--secondary); /* Ganti Warna Link */
...
                body { 
                    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; 
                    background: linear-gradient(135deg, var(--accent), var(--secondary), var(--primary)); /* Ganti Latar */
                    padding: 20px; 
                    min-height: 100vh;
                    position: relative;
                }
...
                h2 { 
                    color: var(--primary); 
                    border-bottom: 3px solid var(--secondary); /* Ganti Warna Garis Bawah */
                    padding-bottom: 10px; 
                    margin-top: 40px; 
                    margin-bottom: 20px; 
                    font-size: 1.5rem; 
...
                
                th { 
                    background: linear-gradient(135deg, var(--primary), var(--secondary)); /* Ganti Warna Header Tabel */
                    color: white; 
                    font-weight: 600;
                }
                
                tr:nth-child(even) { 
                    background-color: rgba(168, 218, 220, 0.1); /* Biru Cerah transparan */
                }
                
                tr:hover {
                    background-color: rgba(168, 218, 220, 0.2); /* Biru Cerah transparan hover */
                    transition: var(--transition);
                }
                
                code, .api-key-value { 
...
                
                .edit-btn { 
                    background: var(--secondary); /* Edit jadi biru sedang */
                }
                
                .edit-btn:hover { 
                    background: #5a8bae; /* Sedikit lebih gelap */
                    transform: translateY(-2px);
                }
                
                .delete-btn { 
...
                
                .api-info-box {
                    background: linear-gradient(135deg, #e0f7fa, #b2ebf2); /* Nuansa biru muda */
